...
<body bgcolor="white" text="#FF0000" background="static/img/miao2.jpg">
...
<div class="container">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" action="selectCatServlet" method="post">
                                <input type="hidden" name="tip" value="2">
                                <div class="col-lg-8 form-group">
                                    <%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">Cat's name</label>
                                    <div class="col-lg-8">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <!---在此插入信息-->
                        <%
                                ArrayList<Cat> catData = new ArrayList<>();
                                catData = (ArrayList<Cat>)request.getAttribute("data");
                                if (catData == null) {
                                    CatDao catDao = new CatDao();
                                    catData = (ArrayList<Cat>)catDao.findAll();
                                }
                                for (Cat cat : catData) {
                        ...
                        <td><%= cat.getGender() %></td>
                        <td><%= cat.getPrice() %></td>
                        <td><%= cat.getBreeder() %></td>
                        <td><%= cat.getAttendance() %></td>
                        <td>
                            ...
                            <button type="button" class="btn btn-danger btn-xs" onclick="deleteProduct(<%= cat.getId() %>)">delete</button>
                        </td>
                        </tbody>
                        <%} %>
                    </table>
    ...
    <script type="text/javascript">
        ...
        function deleteProduct(id) {
            ...
            if(con==true){
                location.href = "deleteCatServlet?id="+id;
            }
        }
    </script>

    <form class="form-horizontal" method="post" action="addCatServlet">   <!--保证样式水平不混乱-->
        <!-- 模态框（Modal） -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">Worth</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addPress" required="required" name="price" >
                                <label class="control-label" for="addPress" style="display: none;"></label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">Breeder's ID</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addNum" required="required" name="employeeID" >
                                <label class="control-label" for="addPress" style="display: none;"></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">Attendance</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addNum" required="required" name="attendance">
