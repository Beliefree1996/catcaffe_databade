...
<%@ page import="com.bb.domain.Evaluation" %>
<%@ page import="com.bb.dao.EvaluationDao" %>
...
<body bgcolor="white" text="#FF0000" background="static/img/miao3.jpg">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="selectEmployeeServlet" method="post">
                                <input type="hidden" name="tip" value="2">
                                    <div class="col-lg-8 form-group">
                                        <%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">Employee's name</label>
                                        <div class="col-lg-8">
                        ...
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                                 ...
                                 employeeData = (ArrayList<Employee>)request.getAttribute("data");
                                 if (employeeData == null) {
                                     EmployeeDao employeeDao = new EmployeeDao();
                                     employeeData = (ArrayList<Employee>)employeeDao.findAll();
                                 }
                             ...
                             %>
								<tbody>
                                    ...
                                    <td><%= employee.getTechnicalTitle() %></td>
                                    <td><%= employee.getManager() %></td>
                                    <td><%= employee.getMonthSalary() %></td>
                                  <td><%= employee.getHomeAddress() %></td>

                                    <td>
<%--                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal"--%>
<%--                                            id="btn_update" href="${pageContext.request.contextPath}/product-update.jsp">alter</button>--%>
                                    <button type="button" class="btn btn-danger btn-xs" onclick="deleteProduct(<%= employee.getId() %>)">delete</button>
                                        <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#updateModal"
                                                id="btn_update" onclick="showEvaluation(<%= employee.getId() %>)">evaluation</button>
                                    </td>
                          	  </tbody>
                       <%} %>
                        </table>
...
<%--                <%= employeeId%> = id--%>
            ...
            function deleteProduct(id) {
                ...
                if(con==true){
                    location.href = "deleteEmployeeServlet?id="+id;
                }
            }
        </script>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                            <%
                                ArrayList<Evaluation> evaluationData = new ArrayList<>();
                                evaluationData = (ArrayList<Evaluation>)request.getAttribute("data");
                                if (evaluationData == null) {
                                    EvaluationDao evaluationDao = new EvaluationDao();
                                    evaluationData = (ArrayList<Evaluation>)evaluationDao.findById(1);
                                }
                                for (Evaluation evaluation : evaluationData) {
                            %>
                            <tbody>
                            <td><%= evaluation.getUserName() %></td>
    ...
    <form class="form-horizontal" method="post" action="addEmployeeServlet">   <!--保证样式水平不混乱-->
        <!-- 模态框（Modal） -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">Age</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addBookName" required="required" name="age"  >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addAutho" required="required" name="gender" >
                        ...
                        <div class="form-group">
                            <label for="firstname" class="col-sm-3 control-label">Position</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addPress" required="required" name="technicalTitle" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="addNum" required="required" name="monthSalary">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control"  required="required" name="homeAddress" >
                                <label class="control-label" for="addNum" style="display: none;"></label>
                            </div>
                        </div>
